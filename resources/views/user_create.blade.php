                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" class="form-control" name="user_photo" id="user_photo" placeholder="User Photo">
                                </div>
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <select class="form-control" name="role" placeholder="Tingkat User">
